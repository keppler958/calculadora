const screen = document.getElementById('answer');                   // Referência ao input/display onde a expressão e o resultado aparecem
const buttons = document.querySelectorAll('.calc-btn');             // NodeList com todos os botões da calculadora (números, operadores, =, C)
const historyBtn = document.getElementById('history-btn');          // Botão que abre o painel de histórico
